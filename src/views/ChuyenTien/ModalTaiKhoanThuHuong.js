...
function ModalTaiKhoanThuHuong (props) {
  ...
  const handleOk = () => {
    ...
    props.setThuHuongValue(`${searchResult.tenTaiKhoan}, So TK-${soTaiKhoan}`)
    props.hideModal()
  }
    ...
    <div>
      ...
      >
        <div style={styles.groupItem}>
          <div style={styles.label}>Tìm số tài khoản ngân hàng</div>
...
export default ModalTaiKhoanThuHuong